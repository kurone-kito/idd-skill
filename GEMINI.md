...
This file contains tool-specific guidance for
Antigravity CLI (formerly Gemini CLI). When Copilot-specific workflow
names appear, apply the intent in Antigravity using Antigravity's
