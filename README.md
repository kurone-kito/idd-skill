...
| Run an agent on this repository                                    | [`AGENTS.md`](AGENTS.md) (the canonical guide), plus the [`CLAUDE.md`](CLAUDE.md), [`GEMINI.md`](GEMINI.md), and [`.github/copilot-instructions.md`](.github/copilot-instructions.md) adapters |
