...
- **Helper sources**: the helper logic is TypeScript. The only
  hand-edited JS surface is `src/**/*.mts`; the `scripts/*.mjs` and
  `bin/*.mjs` files are generated by `pnpm run build` and committed.
  Edit the `.mts` source, never the generated `.mjs`. See
  [docs/typescript-sources.md](docs/typescript-sources.md).
