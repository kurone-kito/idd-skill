...
function normalizeStatusCheckRollupNode(node) {
...
function fetchChangeRequestBranchAndChecks(deps, owner, repo, number) {
  let after = null;
  let headSha = '';
  let baseRefName = '';
 ...
 * #3275).
 */
function extractIncludedResponseBody(raw) {
 ...
 */
function deriveRetryAfterMs(error, nowMs) {
