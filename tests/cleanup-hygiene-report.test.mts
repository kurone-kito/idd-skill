...
import {
  aggregateMetrics,
  generateMetrics,
} from '../src/scripts/cleanup-hygiene-report.mts';

// generateMetrics CLI args carry nullable since/format/help fields the
// tests never exercise; widen the two-field literals structurally.
type ReportArgs = Parameters<typeof generateMetrics>[0];
