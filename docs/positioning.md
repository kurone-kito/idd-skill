...
| Execution-agent neutral           | ✓ (Copilot, Claude, Codex, OpenCode, Cursor CLI, Antigravity CLI (formerly Gemini CLI), Grok Build) | ✗ (GitHub Copilot only)         | ✓                      | ✗ (proprietary)   | ✗ (own runtime)      |
