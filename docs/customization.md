...
PR-submit's D3 "Create PR" step applies it to PR body prose (#1982); the
distributed discover, claim, and issue-authoring runtime does not read or apply
it yet. Drafted-issue-prose enforcement ships in a follow-up issue (#1983),
blocked by the field landing here first.
