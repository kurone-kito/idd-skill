...
| Create or publish a follow-up issue, or edit its held body, under the `issue-authoring` Stage 1 hold | Reversible                | Close a newly created issue or restore its previous body; gate: the companion is installed, the mechanical pre-publish gate and critique pass are green, and the configured authoring label (default: `status:authoring`) remains until explicit release                                                                                                                                                                                                                                                                                                                                                          | B3-C (`idd-work.instructions.md`, `idd-work-lite.instructions.md`, `skills/issue-authoring/SKILL.md`)                                         |
| Create the configured issue-authoring repository label (default: `status:authoring`) during Stage 1  | Reversible                | Delete the label only when Stage 1 created it and repository permission allows; leave a pre-existing or undeletable label intact                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Stage 1 (`skills/issue-authoring/SKILL.md`, `skills/issue-authoring/references/workflow-boundary.md`)                                         |
| Apply the configured issue-authoring label (default: `status:authoring`) to a follow-up issue        | Reversible                | Remove the label from that issue; if application fails after issue creation, close the created issue before stopping                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Stage 1 (`skills/issue-authoring/SKILL.md`, `skills/issue-authoring/references/workflow-boundary.md`)                                         |
| Post a Stage 1 cross-reference comment for a reused or related follow-up issue                       | Reversible                | Post a correcting comment or edit the cross-reference; gate: the reuse-first active-claim/open-PR check permits the cross-reference                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Stage 1 (`skills/issue-authoring/SKILL.md`, `skills/issue-authoring/references/contract.md`)                                                  |
| Record a follow-up in a separate issue comment when the companion is unavailable                     | Reversible                | Post a correcting or follow-up comment; do not create an issue directly from the work route                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | B3-C (`idd-work.instructions.md`, `idd-work-lite.instructions.md`)                                                                            |
