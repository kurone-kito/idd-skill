...
### Work, branch, worktree & follow-up authoring (B1-C6)
...
| Create or publish a follow-up issue, or edit its held body, under the `issue-authoring` Stage 1 hold | Reversible                | Close a newly created issue or restore its previous body; gate: the companion is installed, the mechanical pre-publish gate and critique pass are green, and the `status:authoring` hold remains until explicit release                                                                                                                                                                                                                                                                                                                                                                                           | B3-C (`idd-work.instructions.md`, `idd-work-lite.instructions.md`, `skills/issue-authoring/SKILL.md`)                                         |
| Create or apply the `status:authoring` label during Stage 1                                          | Reversible                | Remove the label; if application fails after issue creation, close the created issue before stopping                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Stage 1 (`skills/issue-authoring/SKILL.md`, `skills/issue-authoring/references/workflow-boundary.md`)                                         |
