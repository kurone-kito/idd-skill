...
| Create the configured issue-authoring repository label (default: `status:authoring`) during Stage 1  | Reversible                | Verify that no other held issue uses the label; delete it only when Stage 1 created it and repository permission allows, otherwise leave it intact and record the non-destructive correction                                                                                                                                                                                                                                                                                                                                                                                                                      | Stage 1 (`skills/issue-authoring/SKILL.md`, `skills/issue-authoring/references/workflow-boundary.md`)                                         |
