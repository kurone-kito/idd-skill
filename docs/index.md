...
| investigation | [IDD Canonical Phase Re-order Proposal](phase-reorder-proposal.md) | Records a readability-first proposal for replacing decimal phase IDs while preserving routing and marker compatibility. |
