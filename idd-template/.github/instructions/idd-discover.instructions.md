...
Unlabeled targets follow trusted owner `anchor` logs. `release`/`release-guard`
without `release-complete` is not startable; ambiguity fails closed. Labels
never clear this; later generation does.
