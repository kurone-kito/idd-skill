...
Unlabeled issues follow `anchor` logs; incomplete generations block. Exact
anchor/set/session `release-complete` gates release/guard; absent labels are
not proof; later release clears labels.
