...
by its `{{PROJECT_MARKER_PREFIX}}-roadmap-id` marker or by recognizing it as
...
`{{PROJECT_MARKER_PREFIX}}-roadmap-id` marker. Add the marker to a legacy
...
carrying an `<!-- {{PROJECT_MARKER_PREFIX}}-roadmap-id: ... -->` marker
