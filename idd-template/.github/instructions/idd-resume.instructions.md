...
| No active claim after release + matching local worktree is occupied or unreadable               | STOP — recover the local worktree (§LWR) or verify owner-resume / forced-handoff successor claim-id                           |
...
| Active stale claim (≥ 24 h, other session) + matching local worktree is occupied or unreadable  | STOP — recover the local worktree (§LWR) or verify owner-resume / forced-handoff successor claim-id                           |
