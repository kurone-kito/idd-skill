...
1. PATH A/PATH B (from `idd-review-triage.instructions.md` E4): PATH A
   ...
   bodies, critique-pass findings, Copilot inline review-thread
   comments); PATH B is advisory feedback: Copilot's and CI advisory
   bots' review-summary bodies and regular comments, included for
