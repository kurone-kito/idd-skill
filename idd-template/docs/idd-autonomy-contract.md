...
| Link a follow-up as a native GitHub sub-issue of the roadmap (autonomous gap) | Reversible                | `gh issue edit <roadmap> --remove-sub-issue <n>`                                                                                                                         | `idd-roadmap-audit.instructions.md` "Autonomous gaps found"; runs before the task-list update, for both a newly created and a reused/existing follow-up |
