...
[Helper-assisted path](https://github.com/kurone-kito/idd-skill/blob/v0.11.0/idd-template/ONBOARDING.md#helper-assisted-path)'s
...
[Step 5 — Update agent entry files](https://github.com/kurone-kito/idd-skill/blob/v0.11.0/idd-template/ONBOARDING.md#step-5--update-agent-entry-files)
...
use (see
[Optional companion boundary](https://github.com/kurone-kito/idd-skill/blob/v0.11.0/idd-template/ONBOARDING.md#optional-companion-boundary)
