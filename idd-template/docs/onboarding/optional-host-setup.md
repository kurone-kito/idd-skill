...
[`ONBOARDING.md`](https://github.com/kurone-kito/idd-skill/blob/v0.12.1/idd-template/ONBOARDING.md)
...
The [dry-run — Readiness assessment](https://github.com/kurone-kito/idd-skill/blob/v0.12.1/idd-template/ONBOARDING.md#dry-run--readiness-assessment)
