 ...
 */
export function collectContextCeilingViolations(
  config: ContextCeilingConfig | null | undefined,
  bundles: readonly ContextCeilingBundleStat[],
...
/** Result of {@link extractHeadingSection}. */
